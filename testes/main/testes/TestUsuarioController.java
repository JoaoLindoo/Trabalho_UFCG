...
public class TestUsuarioController {
	...
	public void testAdicionar() throws Exception {
		...
		controller.cadastrarEletronico("Joao", "3322", "Guitarrinha", 150, "Pancad�o");
		
		controller.adicionar("Redson", "7813", "redson@ccc.ufcg.br");
		controller.cadastrarBluRaySerie("Redson", "7813", "24 Horas", 100, "Vida loka", 500, "18", "A��o", 1);
		controller.cadastrarBluRaySerie("Redson", "7813", "Supernatural", 100, "Ca�ando o capeta", 500, "18", "A��o", 1);
	}
	@Test
	...
	public void testOrdenacaoValor() {
		assertEquals("FILME: Xuxa, R$ 2.0, Nao emprestado, 60 min, 14, Infantil, 2016|"
				...
				+ "SERIE: Supernatural, R$ 100.0, Nao emprestado, 0 min, 18, A��o, Temporada 1|"
				+ "SERIE: 24 Horas, R$ 100.0, Nao emprestado, 0 min, 18, A��o, Temporada 1|"
				+ "JOGO ELETRONICO: Guitarrinha, R$ 150.0, Nao emprestado, Pancad�o|", controller.ordenacaoItensValor());
	}

	@Test
	public void testOrdenacaNome() {
		assertEquals("SERIE: 24 Horas, R$ 100.0, Nao emprestado, 0 min, 18, A��o, Temporada 1|"
				+ "JOGO ELETRONICO: Guitarrinha, R$ 150.0, Nao emprestado, Pancad�o|"
				+ "FILME: Jogos Mortais, R$ 15.0, Nao emprestado, 60 min, 16, Terror, 2016|"
				+ "FILME: Pneu Assasino, R$ 10.0, Nao emprestado, 60 min, 14, Terror, 2016|"
				+ "SERIE: Supernatural, R$ 100.0, Nao emprestado, 0 min, 18, A��o, Temporada 1|"
	...
	public void testPesquisarDetalhesItem() throws Exception{
		assertEquals("SERIE: Supernatural, R$ 100.0, Nao emprestado, 0 min, 18, A��o, Temporada 1", controller.pesquisarDetalhesItem("Redson", "7813", "Supernatural"));
	}
