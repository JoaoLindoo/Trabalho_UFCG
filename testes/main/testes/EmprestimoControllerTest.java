...
public class EmprestimoControllerTest {
	...
	public void setUp() throws Exception {
		...
		facade.cadastrarBluRaySerie("Redson", "98888-8888", "The Flash", 30, "The Flash e uma serie de televisão americana desenvolvida por Greg Berlanti, Andrew Kreisberg e Geoff Johns, e estrelada por Grant Gustin.", 160, "12", "Super-Heroi/Acao/Ficcao Cientifica", 3);
		...
		facade.registrarEmprestimo("Lucas", "97777-7777", "Redson", "98888-8888", "Kung-Fu Futebol Clube", "29/08/2017", 3);
	...
	public void testListagem() throws Exception {
		assertEquals("Dono do item: Joao, Nome do item emprestado: Super Mario|Dono do item: Lucas, Nome do item emprestado: Dama|Dono do item: Lucas, Nome do item emprestado: Kung-Fu Futebol Clube|Dono do item: Pedro, Nome do item emprestado: Xadrez|Dono do item: Redson, Nome do item emprestado: The Flash|", facade.listarItensEmprestados());
		assertEquals("JOGO ELETRONICO: FIFA 18, R$ 99.9, Nao emprestado, PS4|JOGO ELETRONICO: PES 18, R$ 99.9, Nao emprestado, PS4|", facade.listarItensNaoEmprestados());
		...
		assertEquals("Emprestimos: EMPRESTIMO - De: Lucas, Para: Redson, Dama, 05/09/2017, 3 dias, ENTREGA: Emprestimo em andamento|EMPRESTIMO - De: Lucas, Para: Redson, Kung-Fu Futebol Clube, 29/08/2017, 3 dias, ENTREGA: Emprestimo em andamento|", facade.listarEmprestimosUsuarioEmprestando("Lucas", "97777-7777"));
		assertEquals("Emprestimos pegos: EMPRESTIMO - De: Lucas, Para: Redson, Dama, 05/09/2017, 3 dias, ENTREGA: Emprestimo em andamento|EMPRESTIMO - De: Joao, Para: Redson, Super Mario, 18/08/2017, 5 dias, ENTREGA: Emprestimo em andamento|EMPRESTIMO - De: Lucas, Para: Redson, Kung-Fu Futebol Clube, 29/08/2017, 3 dias, ENTREGA: Emprestimo em andamento|", facade.listarEmprestimosUsuarioPegandoEmprestado("Redson", "98888-8888"));
		assertEquals("1) 1 emprestimos - JOGO DE TABULEIRO: Xadrez, R$ 20.0, Emprestado, COMPLETO|2) 1 emprestimos - FILME: Kung-Fu Futebol Clube, R$ 3.5, Emprestado, 113 min, 12, Esportes/Acao, 2001|3) 1 emprestimos - JOGO DE TABULEIRO: Dama, R$ 11.5, Emprestado, COMPLETO|4) 1 emprestimos - JOGO ELETRONICO: Super Mario, R$ 20.0, Emprestado, Super Nintendo|5) 1 emprestimos - SERIE: The Flash, R$ 30.0, Emprestado, 200 min, 12, Super-Heroi/Acao/Ficcao Cientifica, Temporada 3|", facade.listarTop10Itens());
	}
